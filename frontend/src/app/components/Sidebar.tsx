...
import {
  LayoutDashboard, CalendarCheck, CalendarDays, Users, PhoneIncoming, PhoneOutgoing, Bell, PhoneCall, Building2, HeartPulse, Circle, BookOpen,
} from "lucide-react";
import { cn } from "./ui/utils";
import { getCliniko, getBolna } from "../api";

export type View =
  | "overview" | "inbound" | "calendar" | "appointments" | "patients" | "outbound" | "followups" | "sessions" | "clinic-setup" | "documentation";
